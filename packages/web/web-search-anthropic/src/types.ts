/**
 * Provider-private wire types for Anthropic's native Messages API. Citeable
 * result items and citation excerpts arrive in separate blocks; the provider
 * joins them by URL. These types do not create a dependency on `ctx.llm`.
 * @module @deepseek-ai/dsh-web-search-anthropic/types
 */
...
/** Anthropic's Messages response envelope. */
export interface AnthropicResponse {
  content?: ContentBlock[]
}

/** Anthropic's error response envelope (best-effort; fields vary). */
