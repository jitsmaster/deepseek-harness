...
import claudeSessionImportRemote from '@deepseek-ai/dsh-claude-session-import/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      permissionPresetsRemote, subagentsRemote, sessionRemote, workspaceRemote, claudeSessionImportRemote,
      workspaceFilesRemote, terminalRemote, officeToPdfRemote,
    ]) {
