...
| [claude-session-import.md](claude-session-import.md) | discovery and one-shot import of Claude Code CLI sessions into a brand-new native DSH session, the wire `DiscoveredSessionView`, and the two stable failure codes |
