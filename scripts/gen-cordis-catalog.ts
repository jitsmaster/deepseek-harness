...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  claudeSessionImportController: 'claude-session-import.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ClaudeSessionImportListValue: 'claude-session-import.md',
  ClaudeSessionImportCreateValue: 'claude-session-import.md',
  ...
  AuthorizationEntryView: 'credentials.md',
  ...
  AuthorizationOutcomeView: 'credentials.md',
  AuthorizationPrompt: 'credentials.md',
  WireAuthorizationPrompt: 'credentials.md',
